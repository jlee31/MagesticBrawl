...
HUNTRESS_ATTACK1_RANGE = [0,0]
HUNTRESS_ATTACK2_RANGE = [0,0]
...
OLD_WIZARD_ATTACK1_RANGE = [0,0]
OLD_WIZARD_ATTACK2_RANGE = [0,0]
OLD_WIZARD_ATTACK_OFFSET = [0,0]
OLD_WIZARD_DATA = CHARACTER_DATA(OLD_WIZARD_SIZE, OLD_WIZARD_SCALE, OLD_WIZARD_OFFSET, OLD_WIZARD_SPEED, OLD_WIZARD_JUMP_HEIGHT, OLD_WIZARD_ATTACK1_RANGE, OLD_WIZARD_ATTACK2_RANGE, OLD_WIZARD_ATTACK_OFFSET)
